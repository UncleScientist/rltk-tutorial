...
use super::{InitialMapBuilder, BuilderMap, Position, Rect, TileType};
...
impl BspInteriorBuilder {
    ...
    fn build(&mut self, rng: &mut RandomNumberGenerator, build_data: &mut BuilderMap) {
        ...
        for i in 0..rooms.len() - 1 {
            ...
            // TODO: clean up bspdungeon & bspinterior duplicate code for draw_corridor
            self.draw_corridor(start_x, start_y, end_x, end_y, build_data);
            build_data.take_snapshot();
        }
    ...
    fn draw_corridor(&mut self, x1: i32, y1: i32, x2: i32, y2: i32, build_data: &mut BuilderMap) {
        let mut x = x1;
        let mut y = y1;
