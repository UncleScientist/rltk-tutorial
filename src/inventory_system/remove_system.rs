...
use crate::{CursedItem, Equipped, GameLog, InBackpack, Name, WantsToRemoveItem};
...
impl<'a> System<'a> for ItemRemoveSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        let (mut gamelog, entities, mut wants_remove, mut equipped, mut backpack, names, cursed) =
            data;
